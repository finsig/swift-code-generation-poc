...
final class SpArithmeticPerThingsPerbillTests: XCTestCase {
...
fileprivate extension Data {
    ...
    static var expectedSwiftCode = #"""
        ["extension Arithmetic.PerThings {", "typealias Perbill = U32", "}"]
    """#.data(using: .utf8)!
    
    static var expectedFullyQualifiedTypealias = #"""
        ["typealias Arithmetic.PerThings.Perbill = U32"]
    """#.data(using: .utf8)!
}
